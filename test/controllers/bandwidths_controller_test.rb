...
class BandwidthsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bandwidth" do
    assert_difference('Bandwidth.count') do
      post bandwidths_url, params: { bandwidth: { interface_name: @bandwidth.interface_name, server_id: @bandwidth.server_id, value: @bandwidth.value, value_id: @bandwidth.value_id } }
    end
  ...
  test "should update bandwidth" do
    patch bandwidth_url(@bandwidth), params: { bandwidth: { interface_name: @bandwidth.interface_name, server_id: @bandwidth.server_id, value: @bandwidth.value, value_id: @bandwidth.value_id } }
